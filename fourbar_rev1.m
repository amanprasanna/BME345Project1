function errors = fourbar_rev1(param,r1,r2,r3,r4,th1,th2,om2,al2)
%fourbar_rev1
%
...
ax = (-al2 * r2 * sin(th2)) - ((om2)^2 * r2 * cos(th2)) ...
  + (-al3 * r3 * sin(th3)) - ((om3)^2 * r3 * cos(th3)) ...
  + (-al4 * r4 * sin(th4)) - ((om4)^2 * r4 * cos(th4));
ay =  (al2 * r2 * cos(th2)) - ((om2)^2 * r2 * sin(th2)) ...
+ (al3 * r3 * cos(th3)) - ((om3)^2 * r3 * sin(th3)) +  ...
